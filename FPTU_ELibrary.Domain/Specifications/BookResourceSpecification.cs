...
public class BookResourceSpecification : BaseSpecification<BookResource>
{
    public int PageIndex { get; set; }
    public int PageSize { get; set; }

    public BookResourceSpecification(BookResourceSpecParams specParams, int pageIndex, int pageSize)
        : base(br =>
            // Search with terms
            ...
            (
                ...
                // Book title
                (!string.IsNullOrEmpty(br.Book.Title) && br.Book.Title.Contains(specParams.Search))
            ))
    {
        ...
        if (!string.IsNullOrEmpty(specParams.Sort))
        {
            ...
            var sortMappings = new Dictionary<string, Expression<Func<BookResource, object>>>()
            {
                { "BOOKTITLE", x => x.Book.Title },
