...
//         var bookResourceSpec = specification as LibraryResourceSpecification;
...
//         var totalEmployeeWithSpec = await _unitOfWork.Repository<LibraryResource, int>().CountAsync(bookResourceSpec);
//         // Count total page
...
//         	var bookResourceDtos = _mapper.Map<IEnumerable<LibraryResourceDto>>(entities);
//         	
//         	// Pagination result 
//         	var paginationResultDto = new PaginatedResultDto<LibraryResourceDto>(bookResourceDtos,
...
// 		int bookId, LibraryResourceDto dto, string byEmail)
// 	{
//         try
//         {
...
//             await _unitOfWork.Repository<LibraryResource, int>().AddAsync(_mapper.Map<LibraryResource>(dto));
//             // Save to DB
//             if (await _unitOfWork.SaveChangesAsync() > 0)
//             {
...
// 	}
// 	
//     public async Task<IServiceResult> UpdateAsync(int id, LibraryResourceDto dto, string byEmail)
//     {
//         try
// 		{
