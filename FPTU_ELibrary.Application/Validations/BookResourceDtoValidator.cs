...
public class BookResourceDtoValidator : AbstractValidator<BookResourceDto>
{
    public BookResourceDtoValidator(string langContext)
    {
        var langEnum =
        ...
        RuleFor(e => e.ResourceType)
            .Must(str => !string.IsNullOrEmpty(str) && Enum.TryParse(typeof(BookResourceType), str, out _))
            .WithMessage(isEng
